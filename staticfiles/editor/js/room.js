...
const channel_id = document.querySelector('[data-channel-id]')?.dataset.channelId || "{{channel.id}}";
const userprofile = document.querySelector('[data-user]')?.dataset.user || "{{userprofile}}";
const userprofile_id = document.querySelector('[data-user-id]')?.dataset.userId || "{{userprofile.id}}";
const roomName = document.querySelector('[data-room-name]')?.dataset.roomName || "{{room_name}}";
const permitted_users = document.querySelector('[data-permitted-users]')?.dataset.permittedUsers || "{{channel.has_permission.all}}";
const selected_programing_language = document.querySelector('[data-language]')?.dataset.language || "{{channel.programing_language}}";
